    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', models.CharField(max_length=13, unique=True, validators=[Validators.phone_number_validators.iran_phone_validate])),
                ('created_datetime', models.DateTimeField(auto_now_add=True, null=True)),
                ('expired_datetime', models.DateTimeField(blank=True, default=datetime.datetime(2021, 6, 19, 5, 11, 29, 905960, tzinfo=utc), null=True)),
